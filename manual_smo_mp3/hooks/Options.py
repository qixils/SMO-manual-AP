...
class ActionRando(Toggle):
    """Shuffle all Basic Actions (as listed in the Action Guide) into the pool. You start with the "Capture" and "Enter Pipe" and "Cap Throw and Hold" actions. There are 2 locations for getting on Jaxi and the Motor scooter."""
